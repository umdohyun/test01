...
class TestAPIEndpoints:
    ...
    def test_save_game_record_success(self, mock_get_db, client, mock_db):
        ...
        mock_cursor.fetchone.side_effect = [
            (1,),  # verify_token - user_id
            (1, 1000, 5, 10, "2026-06-17 10:00:00")  # 저장된 게임 기록
        ]
        mock_cursor.lastrowid = 1
    ...
    def test_get_leaderboard(self, mock_get_db, client, mock_db):
        ...
        mock_cursor.fetchall.return_value = [
            ("player1@example.com", 5000, 10, 50, "2026-06-17 10:00:00"),
            ("player2@example.com", 4000, 8, 40, "2026-06-17 09:00:00"),
        ]
    ...
    def test_get_top_score_with_records(self, mock_get_db, client, mock_db):
        ...
        mock_cursor.fetchone.return_value = (
            "top@example.com", 10000, 15, 100, "2026-06-17 10:00:00"
        )
    ...
    def test_get_my_history(self, mock_get_db, client, mock_db):
        ...
        # verify_token과 이력 모킹
        mock_cursor.fetchone.return_value = (1,)  # verify_token - user_id
        mock_cursor.fetchall.return_value = [
            (1, 1000, 5, 10, "2026-06-17 10:00:00"),
            (2, 2000, 8, 20, "2026-06-17 09:00:00"),
        ]
...
class TestDatabaseOperations:
    ...
    def test_get_db_returns_connection(self, mock_connect):
        ...
        mock_connect.assert_called_once_with("tetris.db")
